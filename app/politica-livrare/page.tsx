    ...
    <div className="section-padding bg-gray-50 min-h-screen">
      <div className="container-custom max-w-4xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-xl shadow-lg p-8 space-y-6">
          ...
          {/* SERVICE PRIN CURIER */}
          <section id="service-curier" className="border-t border-gray-200 pt-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Service prin curier</h2>
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">1. Obiectul serviciului</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">2. Dispozitive acceptate</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">3. Procesul de service prin curier</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">4. Timp de reparație</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">5. Manopera și costuri</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">6. Reparații suplimentare</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">7. Defecte preexistente</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">8. Capac spate din sticlă</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">9. Codul de deblocare și datele personale</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">10. Date personale</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">11. Limitarea răspunderii</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">12. Acceptarea termenilor</h3>
                <p>
